package com.dtnsm.lms.border.controller;
...
import com.dtnsm.lms.border.service.BorderFileService;
import com.dtnsm.lms.border.service.BorderMasterService;
import com.dtnsm.lms.border.service.BorderService;
...
public class BorderAdminController {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable int id, HttpServletRequest request){
        ...
        Resource resource = fileService.loadFileAsResource(borderFile.getSaveName());
