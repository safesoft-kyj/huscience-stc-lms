...
public enum BinderAlarmType {
    ...
    BINDER_REVIEW("email/binder-review", "[LMS/%s] Digital Binder 검토 요청(7)일 전", "${empName}, ${inDate}"),
    BINDER_REVIEWED("email/binder-reviewed", "[LMS/%s] Digital Binder 승인 알림", "사용자의 Binder 검토가 완료 되었습니다."),
    BINDER_UPDATE("email/binder-update", "[LMS/%s] Digital Binder 정기 검토_업데이트 요청", "최신 정보로 Binder 업데이트를 진행 후 매니저에게 검토 요청을 진행해 주세요."),
