...
//import com.dtnsm.lms.domain.DTO.DataStorage.*;
//import com.dtnsm.lms.domain.DTO.BusinessEntities;
//
...
//			DataStorage.EmailDataSourcesObjects getDataSourceDetails = DataStorage.emailDataSourceObject("Bubble Chart.eml", ".eml");
...
//			DataStorage.EmailDataSourcesObjects getDataSourceDetails = DataStorage.emailDataSourceObject("Bulleted List.msg", ".msg");
...
//			DataStorage.EmailDataSourcesObjects getDataSourceDetails = DataStorage.emailDataSourceObject("Chart with Filtering, Grouping, and Ordering.msg", ".msg");
//			DataStorage.EmailDataSourcesNames dataSourceNames = DataStorage.emailDataSourceName(".msg");
//			DocumentAssembler assembler = new DocumentAssembler();
//			assembler.assembleDocument(CommonUtilities.getDataPath(srcDocument),
//				CommonUtilities.getOutPath(docReport),
