...
import com.dtnsm.lms.course.domain.*;
import com.dtnsm.lms.course.service.CourseSectionFileService;
...
public class CourseSectionAdminController {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable long id, HttpServletRequest request){
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + courseSectionFile.getFileName() + "\"")
                .body(resource);
    }
}
