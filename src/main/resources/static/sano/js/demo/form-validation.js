...
$(document).on('nifty.ready', function() {
    ...
    $('#demo-bvd-notempty').bootstrapValidator({
        ...
        feedbackIcons: faIcon,
        fields: {
        // new-Study_p11.html 작업용 시작
        studyurl: {
            message: 'The Study URL is not valid',
            validators: {
                notEmpty: {
                    message: 'The Study URL is required.'
                }
            }
        },
        studyname: {
            message: 'The Study Name is not valid',
            validators: {
                notEmpty: {
                    message: 'The Study Name is required.'
                }
            }
        },
        description: {
            message: 'The Study Description is not valid',
            validators: {
                notEmpty: {
                    message: 'The Description URL is required.'
                }
            }
        },
        protocolname: {
            message: 'The Protocol Name is not valid',
            validators: {
                notEmpty: {
                    message: 'The Protocol Name is required.'
                }
            }
        },
         // new-Study_p11.html 작업용 끝
         // new-Users_p12.html 작업용 시작
          firstName: {
            validators: {
                notEmpty: {
                    message: 'The first Name name is required and cannot be empty'
                },
                regexp: {
                    regexp: /^[A-Z\s]+$/i,
                    message: 'The first Name name can only consist of alphabetical characters and spaces'
                }
            }
        },
         lastName: {
