    ...
    function html5Upload() {	
		...
		sUploadURL= '/file_uploader_html5';     //다중파일업로드 URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
		...
		// alert(encodeURIComponent(tempFile.name) + " !! "+ tempFile.size + " !! " + tempFile.type + "!!" );
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			// sUrl : '/photoUpload',
			sUrl : '/file_uploader',
			sCallback : '/editor/sample/photo_uploader/callback.html',  //업로드 이후  redirect 페이지 url
			// sCallback : '/resources/static/editor/sample/photo_uploader/callback.html',  //업로드 이후  redirect 페이지 url
