		...
		setTimeout(function(){
			...
			for(var index=0;index < numImages; index++){
				...
				if(image.naturalWidth !== undefined && image.naturalWidth !== 0){
					...
					proxyImage.data("templates.index", index);
					
					proxyImage.on("load", function(){
						var index = jQuery(this).data("templates.index");
						checkComplete(objImages[index], false);
					});
...
function UGThumbsGeneral(){
	...
	var g_options = {
		...
		this.getItemByThumb = function(objThumb){
			...
			var index = objThumb.data("templates.index");
...
function UGSlider(){
	...
	function resizeSlideItem(objSlide){
		var index = objSlide.data("templates.index");
	...
	function setItemToSlide(objSlide, objItem){
		...
		try{
			...
			if(objItem == null){
				objItemWrapper.html("");
				objSlide.removeData("templates.index");
				objSlide.removeData("type");
				objSlide.removeData("urlImage");
				return(false);
			}
			
			var currentIndex = objSlide.data("templates.index");
			
			objSlide.data("templates.index",objItem.index);
	...
	function onItemImageUpdate(event, index, urlImage){
		...
		if(g_objSlide1.data("templates.index") == index){
			objItem = g_gallery.getItem(index);
			setImageToSlide(g_objSlide1, objItem, true);	//force
		}
		
		if(g_objSlide2.data("templates.index") == index){
			objItem = g_gallery.getItem(index);
			setImageToSlide(g_objSlide2, objItem, true);
		}
		
		if(g_objSlide3.data("templates.index") == index){
			objItem = g_gallery.getItem(index);
	...
	function getSlideDirection(objItem){
		...
		var currentIndex = slides.objCurrentSlide.data("templates.index");
...
function UGCarousel(){
	...
	function run(){
		...
		if(g_temp.isFirstTimeRun == true){
			...
			jQuery.each(g_arrItems, function(index, item){
				item.objThumbWrapper.data("templates.index", index);
	...
	function getTileClones(objTile, numClones, dir){
		...
		var index = objTile.data("templates.index");
		if(index == undefined){
