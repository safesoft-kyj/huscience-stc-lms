...
(function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
            var $td = $(this),
                $tr = $td.parent(),
                item = that.data[$tr.data('templates.index')],
        ...
        this.$selectItem.off('click').on('click', function (event) {
            ...
            var $this = $(this),
                ...
                row = that.data[$this.data('templates.index')];
            ...
            if (that.options.singleSelect) {
                that.$selectItem.not(this).each(function () {
                    that.data[$(this).data('templates.index')][that.header.stateField] = false;
                });
            ...
            for (var key in events) {
                that.$body.find('>tr:not(.no-records-found)').each(function () {
                    ...
                    $td.find(el).off(name).on(name, function (e) {
                        var index = $tr.data('templates.index'),
                            row = that.data[index],
                            value = row[field];
    ...
    BootstrapTable.prototype.updateRows = function () {
        ...
        this.$selectItem.each(function () {
            that.data[$(this).data('templates.index')][that.header.stateField] = $(this).prop('checked');
        });
    };
    ...
    BootstrapTable.prototype.insertRow = function (params) {
        if (!params.hasOwnProperty('templates.index') || !params.hasOwnProperty('row')) {
            return;
        }
    ...
    BootstrapTable.prototype.toggleRow = function (params, visible) {
        ...
        if (params.hasOwnProperty('templates.index')) {
    ...
    BootstrapTable.prototype.expandAllRows = function (isSubTable) {
        if (isSubTable) {
            ...
            for (var i = 0; i < trs.length; i++) {
                this.expandRow_(true, $(trs[i]).data("templates.index"));
            }
        }
    };
    ...
    BootstrapTable.prototype.collapseAllRows = function (isSubTable) {
        if (isSubTable) {
            ...
            var trs = this.$body.children();
            for (var i = 0; i < trs.length; i++) {
                this.expandRow_(false, $(trs[i]).data("templates.index"));
            }
        }
    };
