...
var Handle = /** @class */ (function () {
    ...
    Handle.prototype.update = function (target) {
        ...
        this.context.invoke('templates.base.notice.update', target);
        if (isImage) {
            var $image = $$1(target);
...
var HintPopover = /** @class */ (function () {
    ...
    HintPopover.prototype.nodeFromItem = function ($item) {
        var hint = this.hints[$item.data('templates.index')];
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        popover: {
            ...
            table: [
                ['templates.base.notice.add', ['addRowDown', 'addRowUp', 'addColLeft', 'addColRight']],
                ['delete', ['deleteRow', 'deleteCol', 'deleteTable']]
            ],
            air: [
                ['color', ['color']],
