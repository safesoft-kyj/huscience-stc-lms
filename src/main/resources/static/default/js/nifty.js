    ...
    var $menulink               = null,
        ...
        bindSmallNav = function(){
            ...
            $menulink.each(function(){
                ...
                $('#mainnav-menu-wrap > .nano').on("templates.base.notice.update", function(){
        ...
        updateAffix = function(){
            if(!ignoreAffix){
                try{
                    niftyMainNav.niftyAffix('templates.base.notice.update');
                }catch(err){
                    ignoreAffix = true;
                }
            }
...
!function ($) {
    ...
    var niftyAside = null, niftyContainer, niftyWindow = $(window),
        ...
        updateAside = function(){
            try{
                niftyAside.niftyAffix('templates.base.notice.update');
            }catch(err){}
            var cssProp = {};
...
!function ($) {
    ...
    $.fn.niftyAffix = function(method){
        return this.each(function(){
            ...
            }else if (method == 'templates.base.notice.update') {
